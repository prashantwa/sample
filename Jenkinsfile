...
node {
    ...
    withCredentials([file(credentialsId: JWT_KEY_CRED_ID, variable: 'jwt_key_file')]) {
        stage('Create Scratch Org') {
            ...
            rc = sh returnStatus: true, script: "\'C:/Program Files/Heroku/bin/\'sfdx _ force:auth:jwt:grant --clientid ${CONNECTED_APP_CONSUMER_KEY} --username ${HUB_ORG} --jwtkeyfile \'../\'\'../\'secrets\'/\'sfdcserver.key --setdefaultdevhubusername --instanceurl ${SFDC_HOST}"
